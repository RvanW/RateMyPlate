...
public class Plate implements Serializable {
    ...
    public float getRating() {
        ...
        Context applicationContext = OverviewActivity.getContextOfApplication();
    ...
    public Plate(Bitmap image, String title) {
        super();

        this.title = title;
        Log.v("image width: ",image.getWidth()+"");
        Log.v("image height: ", image.getHeight() + "");
        Log.v("ID: ", id+"");
